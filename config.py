...
OWNER_ID = int(getenv("OWNER_ID", 7360566773))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/rainbow_team_tel")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+TFOHkap7Wv9hMWZk")
